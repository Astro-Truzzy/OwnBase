...
const PARALLAX_IMAGE_SIZES = "(max-width: 640px) 128px, (max-width: 768px) 224px, 320px";
  ...
  return (
    ...
    >
      <Image
        ...
        decoding="async"
        className={cn(
          "aspect-4/3 h-20 w-32 rounded-lg object-cover sm:h-40 sm:w-56 md:h-52 md:w-80",
          imageClassName,
        )}
      />
    </motion.div>
