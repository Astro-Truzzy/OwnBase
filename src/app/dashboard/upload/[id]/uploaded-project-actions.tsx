  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      <button
        ...
        disabled={isDeleting}
        className="inline-flex items-center gap-2 rounded-lg border border-red-500/35 bg-transparent px-4 py-2 text-sm font-medium text-red-600 transition-colors hover:bg-red-500/10 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-background disabled:opacity-50 dark:text-red-400"
